...
class GCCN_5(nn.Module):
    def __init__(self, neurons = [], weights = None, p_bins = 5, t_bins = 16, device = 'cpu', l_bias = False):
        super(GCCN_5,self).__init__()
        self.linear_1 = nn.Linear(neurons[0], neurons[1], bias = l_bias)
        self.GC_1 = EquivariantLayer(neurons[1], neurons[2], R_in = 1, R_out = 4, device = device)
        self.GC_2 = EquivariantLayer(neurons[2], neurons[3], R_in = 4, R_out = 4, device = device)
        self.amp = AMP(regular_size = 4)
...
class GCCN_6(nn.Module):
    def __init__(self, neurons = [], weights = None, p_bins = 5, t_bins = 16, device = 'cpu', l_bias = False):
        super(GCCN_6,self).__init__()
        self.linear_1 = nn.Linear(neurons[0], neurons[1], bias = l_bias)
        self.GC_1 = EquivariantLayer(neurons[1], neurons[2], R_in = 1, R_out = 8, device = device)
        self.GC_2 = EquivariantLayer(neurons[2], neurons[3], R_in = 8, R_out = 8, device = device)
        self.amp = AMP(regular_size = 8)
